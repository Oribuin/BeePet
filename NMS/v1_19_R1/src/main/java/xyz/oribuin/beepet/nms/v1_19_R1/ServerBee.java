package xyz.oribuin.beepet.nms.v1_19_R1;
...
import xyz.oribuin.beepet.nms.v1_19_R1.goal.FollowGoal;
...
public class ServerBee extends Bee {
    ...
    public ServerBee(final Player owner, CustomBeeSettings bee) {
        ...
        this.goalSelector.removeAllGoals(); // Remove all goals from the bee
